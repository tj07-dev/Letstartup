                ...
                <div class="col-sm-8 mt-5 mb-4 ml-4" style="background: repeating-linear-gradient( 45deg , #fff6e5, #ffebde 155px) fixed center;" >
                    ...
                    <div class="text-center p-3 mt-4 mb-5" style="background: repeating-linear-gradient( 45deg , #aad8ff, #c8e0ff 155px) fixed center;border-radius: 22px;/*background: repeating-linear-gradient( 45deg , #fff6e5, #ffebde 155px) fixed center;*/">
                        ...
                        ?></small>
                                ...
                                <div class="col"><i class="fa">Posts</i><hr></div>
                                <div class="col"><i class="fa">Followers</i><hr></div>
                                <div class="col"><i class="fa">Following</i><hr></div>
                                </div>
                                <div class="row" style="color: black;">
                                <div class="col"><i class="fa"><?php echo $num_of_p_u;?></i><hr></div>
                                <div class="col"><i class="fa"><?php echo $row_ufo['follow'];?></i><hr></div>
                                <div class="col"><i class="fa"><?php echo $row_uf['follow'];?></i><hr></div>
                                </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="nav nav-tabs justify-content-sm-end" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link " id="posts-tab" data-toggle="tab" href="#posts" role="tab" 
                             aria-controls="posts" aria-selected="true">My Posts</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" id="o_posts-tab" data-toggle="tab" href="#o_posts" role="tab" 
                             aria-controls="o_posts" aria-selected="false">Recent Posts</a>
                        </li>
                    </ul>
